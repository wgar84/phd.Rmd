...
\hypersetup{breaklinks=true,
            ...
            pdftitle={Error Rates in Modularity Hypothesis Testing: Comparing Linear and Geometric Morphometrics},
            colorlinks=true,
            citecolor=blue,
            urlcolor=blue,
            linkcolor=magenta,
...
comparison to traditional ways of measuring morphological features,
Procrustes-based estimators for covariance or correlation matrices have
certain properties that difficult their use in this context. In the
present work, we compare methods for representing morphological
variation and for detecting variational modularity using empirical data
and an approach based on the construction of correlation matrices with
known structure.
...
clusters of traits (with little overlap among groups) exhibits a modular
organization, and such structure is thought to emerge as the result of
...
by the modularization of both structures, as shown by a reduction of
...
evidence that the human skull is highly integrated.
...
relying on the correspondence of these units through mammalian
diversification did the same to phylostomid bats. Although using a
landmark-based approach to represent morphological variation, the
authors do not use Procrustes estimators to represent covariance
...
diversification in phylostomids seems robust, considering that this
radiation may have been associated with a very heterogeneous adaptive
landscape, and such heterogeneity may lead to a reorganization of
correlation patterns (Jones, 2007; Jones \emph{et al.}, 2012; Melo \&
Marroig, 2015).
