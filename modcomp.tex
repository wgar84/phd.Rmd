...
derived from Procrustes residuals regarding localized hypotheses
(midpanel of \autoref{fig:Func}a), the Basicranium is detected as a
valid variational module in 27 cases, distributed through matrices with
size either retained or removed. Thus, Procrustes residuals show a
...
representation masks the detection of variational modularity due to
allometry. In local shape variables (lower left panel of
\autoref{fig:Func}a), the effects of this level of interactions can be
