...
\hypersetup{breaklinks=true,
            ...
            pdftitle={Error Rates in Modularity Hypothesis Testing},
            colorlinks=true,
            citecolor=blue,
            urlcolor=blue,
            linkcolor=magenta,
...
diversification in this group seems pretty solid, considering that
phylostomid radiation implies in a very heterogeneous adaptive
landscape, as the authors found out, and such heterogeneity would lead
to a reorganization of correlation patterns (Jones, 2007; Jones \emph{et
al.}, 2012; Melo \& Marroig, 2015)
