...
muscle-bone interactions (Hallgrímsson \& Lieberman, 2008; Herring,
2011; Cardini \& Polly, 2013). The regulation of each step is mediated
by different profiles of genetic expression exhibited by cells
...
(Turing, 1952; Marcucio \emph{et al.}, 2005; Meinhardt, 2008;
Hallgrímsson \emph{et al.}, 2009; Franz-Odendaal, 2011). Each step
...
elements (Bastir \& Rosas, 2005). Moreover, the angulation between
anterior and posterior elements of the Basicranium has changed sensibly
during primate evolution, and such property appears to evolve in
coordination with Facial growth relative to the cranial Vault, in order
to accomodate both structures on each other (Scott, 1958; Lieberman
\emph{et al.}, 2000, 2008). From a developmental standpoint, due to this
heterogeneity of developmental processes acting on the Basicranium, we
should not consider that the Basicranium is a variational module,
further expecting that a test of this property over skull covariance
patterns will fail to reject the null hypothesis of random association
for this region.
...
\autoref{fig:Func}a), the effects of allometric relationships can be
detected due to the removal of isometric variation.
...
to raw local shape variables. And, by removing allometric effects from
local shape variables (lower right panel of \autoref{fig:Func}a),
variational modularity can yet be detected in both Oral and Nasal
regions, while in a number of species, the Vault region is no longer
detected as a variational module. This indicates that, aside from
interactions associated with allometric relationships, Vault integration
may be also achieved through relative brain growth, and, in those
species that lose such integration after removal of allometry, relative
brain growth may approximate an affine transformation, since the
estimation of local shape variables excludes this source of variation
(Márquez \emph{et al.}, 2012). If we consider the observation that, in
...
model, forming a regular network; in constrast, Oral and Nasal elements
...
the Face (Esteve-Altava \emph{et al.}, 2013; Esteve-Altava \&
Rasskin-Gutman, 2014), thus producing an complex pattern of associations
that may be responsible for the variational modularity we observe even
when allometric relationships are removed.
