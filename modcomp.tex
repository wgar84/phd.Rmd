...
detected as a variational module. Vault integration may be achieved
through both allometric relationships and the effect of relative brain
growth; since the estimation of local shape variables excludes affine
...
transformation. This observation might hold if we consider that in
...
2014); thus, as this effect dominates the latter stages of pre-natal
development (Hallgrímsson \& Lieberman, 2008; Lieberman, 2011), the
overall effect over skull covariance structure. In constrast, Oral and
...
variational modularity we are able to detect even when allometric
