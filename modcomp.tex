...
shape as the two main components of organismal form, a concept that
precedes the consolidation of geometric morphometrics (Mosimann, 1970);
second, the use of superimposition-based methods (Generalized Procrustes
Analysis; Rohlf \& Slice, 1990; Goodall, 1991) for the estimation of
shape statistical parameters, such as mean shape and shape covariance
...
estimate (Goodall, 1991; Lele \& McCulloch, 2002), a situation known as
the identifiability problem (Neyman \& Scott, 1948).
...
landmark coordinates; however, when such assumption does not hold,
