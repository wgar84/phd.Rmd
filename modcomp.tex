...
further estimating a metric that represents such partitioning; the null
hypothesis that this partitioning is undistinguishable from random
partitions can be tested using randomization procedures (Mantel, 1967;
...
\emph{et al.}, 2012; Neaux \emph{et al.}, 2015).
