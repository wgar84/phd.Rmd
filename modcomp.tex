...
modular, in the sense that they affect a coherent set of tissue more so
than others (Hallgrímsson \& Lieberman, 2008), although each step affect
...
scale parameter --- ICV --- that is common to both groups), we believe
