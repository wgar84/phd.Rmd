...
A modular organization of the genotype/phenotype map is thought to
emerge as the result of selection for conflicting functional demands
(Wagner \& Altenberg, 1996; Espinosa-Soto \& Wagner, 2010; Rueffler
\emph{et al.}, 2012); for instance, the decoupling between fore- and
hindlimb function in certain mammalian lineages such as bats (Young \&
...
developmental dynamics. In the mammalian skull, development is composed
of sequential steps that may be regarded as modular in the sense that
they are confined to specific skull regions, such as neurocranial growth
induced by the underlying brain or facial growth mediated by post-natal
muscle-bone functional interactions (Hallgrímsson \& Lieberman, 2008;
Zelditch \emph{et al.}, 2009; Herring, 2011). However, these confined
steps tend to also affect adjoining regions through interaction among
developing tissues (Cheverud \emph{et al.}, 1992; Lieberman, 2011;
...
misleading (Hallgrímsson \emph{et al.}, 2009). Furthermore, of
particular importance in the context of mammalian morphological systems
is variation in overall growth rates, which, in adult populations,
emerges into size variation (Porto \emph{et al.}, 2013). This source of
variation affects the overall level of phenotypic correlations among
morphological traits (Wagner, 1984; Young \& Hallgrímsson, 2005), and
the magnitude of integration has important consequences for both the
evolution of mean phenotypes among species (e.g. Marroig \& Cheverud,
2005, 2010) and the evolution of morphological integration itself
