...
set, calculating MHI and RV values for each iteration. These values were
used to construct distributions for both statistics that represent the
...
set is then compared to this distribution for all correlation/covariance
matrices in our sample. For Modularity Hypothesis Indexes we consider
