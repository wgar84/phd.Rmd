...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={Guilherme Garcia1,2 \& Gabriel Marroig1},
...
\setlength{\droptitle}{-2em}
  ...
  \posttitle{\par}
  \author{Guilherme Garcia\textsuperscript{1,2} \& Gabriel
...
with both AVGi and RV statistics. We expect that power for either tests
