...
Rueffler \emph{et al.}, 2012); for instance, the decoupling between
fore- and hindlimb function in certain mammalian lineages such as bats
(Young \& Hallgrímsson, 2005) and apes (Young \emph{et al.}, 2010) is
accompanied with the modularization of both structures, as shown by a
...
developmental and functional dynamics among traits (Polly, 2008;
Zelditch \& Swiderski, 2011). In the mammalian skull, development is
composed of sequential steps, such as neurocranial growth induced by the
underlying developing brain and allometric growth mediated by
muscle-bone interactions (Hallgrímsson \& Lieberman, 2008; Zelditch
\emph{et al.}, 2009; Herring, 2011; Cardini \& Polly, 2013). The
regulation of each step is mediated by the different profiles of genetic
expression exhibited by cells originated from different embryonic
precursors (Turing, 1952; Franz-Odendaal, 2011) and their response to
signaling factors expressed at the regional level (Meinhardt, 2008;
Hallgrímsson \emph{et al.}, 2009). However, these processes also affect
...
Porto \emph{et al.}, 2013) has a particular importance in the context of
mammalian morphological systems. This source of variation affects the
