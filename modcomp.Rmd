...
Modularity is a characteristic property of biological systems that exhibit an uneven distribution of interactions between their composing elements; i.e., in a given system, certain subsets of elements, denominated modules, interact more among themselves than with other such subsets [@newman_modularity_2006; @mitteroecker_conceptual_2007; @wagner_road_2007; @klingenberg_morphological_2008]. Regarding morphological systems, modularity is conceived as the result of genetic and functional interactions, as expressed throughout development [@cheverud_developmental_1996; @wagner_homologues_1996; @polly_developmental_2008].
