...
The influence of such interactions over covariance or correlation matrices can then be accessed by defining a subset of measurements which fall under the scope of a particular process and further estimating a metric that represents such partitioning; the null hypothesis that this partitioning is undistinguishable from random partitions can be tested using randomization procedures [@mantel_detection_1967; @cheverud_methods_1989].
