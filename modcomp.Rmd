...
However, in comparison to traditional ways of measuring morphological features, Procrustes-based estimators for covariance or correlation matrices have certain properties that difficult their use in this context.
In the present work, we compare methods for representing morphological variation and for detecting variational modularity using empirical data and an approach based on the construction of correlation matrices with known structure.
