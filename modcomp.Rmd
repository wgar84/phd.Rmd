...
Regarding morphological systems, the concept of modular organization is nested within the framework of morphological integration [@olson_morphological_1958; @cheverud_developmental_1996], which refers to the organization of correlations among morphological elements and the set of hypothesis concerning their relationships. In this context, modularity refers to a particular organization of genetic effects over phenotypic variation, articulated through development [genotype/phenotype map; @wagner_homologues_1996]. A modular organization of the genotype/phenotype map is thought to emerge as the result of selection for conflicting functional demands [@wagner_perspective:_1996; @espinosa-soto_specialization_2010; @rueffler_evolution_2012]; for instance, the decoupling between fore- and hindlimb function in certain mammalian lineages such as bats [@young_serial_2005] and apes [@young_development_2010] is accompanied with the modularization of both structures, as shown by a reduction of phenotypic correlations among limbs and an increase in correlations within limbs.

The recognition of such variational modules [@wagner_perspective:_1996; @wagner_road_2007] over covariance or correlation patterns in adult populations involves a comprehension of the underlying developmental dynamics. In the mammalian skull, development is composed of sequential steps that may be regarded as modular in the sense that they are confined to specific skull regions, such as neurocranial growth induced by the underlying brain or facial growth mediated by post-natal muscle-bone functional interactions [@hallgrimsson_mouse_2008; @zelditch_building_2009; @herring_muscle-bone_2011]. However, these confined steps tend to also affect adjoining regions through interaction among developing tissues [@cheverud_effects_1992; @lieberman_epigenetic_2011; @esteve-altava_beyond_2014], and the composed effect of these different processes over correlation patterns in adult phenotypes may be misleading [@hallgrimsson_deciphering_2009]. Furthermore, of particular importance in the context of mammalian morphological systems is variation in overall growth rates, which, in adult populations, emerges into size variation [@porto_size_2013]. This source of variation affects the overall level of phenotypic correlations among morphological traits [@wagner_eigenvalue_1984; @young_serial_2005], and the magnitude of integration has important consequences for both the evolution of mean phenotypes among species [e.g. @marroig_size_2005; @marroig_size_2010] and the evolution of morphological integration itself [@oliveira_covariance_2009; @porto_evolution_2009; @porto_size_2013; @shirai_skull_2010].
