...
Thus, as Modularity Indexes are estimated with a formula that is very similar to that of a *t* statistic (difference between location parameters for two groups, divided by a scale parameter --- ICV --- that is common to both groups), we believe that this statistic is a proper way to represent variational modularity; the robustness of the tests using this statistic reinforce this belief.
