...
Although using a landmark-based approach to represent morphological variation, @monteiro_adaptive_2010 did not rely on Procrustes estimators to covariance structure among these units, and the pattern of reorganization of correlation structure among these units associated with niche diversification in this group seems robust, considering that phylostomid radiation may imply in a very heterogeneous adaptive landscape, and such heterogeneity may lead to a reorganization of correlation patterns [@jones_mutation_2007; @jones_effects_2012; @melo_directional_2015]
