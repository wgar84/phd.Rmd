...
Two principles are central to this framework: first, the conceptual and statistical separation of size and shape as the two main components of organismal form; second, the use of Procrustes methods [@goodall_procrustes_1991] for the estimation of shape statistical parameters, such as mean shape and shape covariance structure. 
