...
Regarding morphological systems, the concept of modular organization is nested within the framework of morphological integration [@olson_morphological_1958; @cheverud_developmental_1996], which refers to the organization of covariances or correlations among morphological elements and the set of hypothesis concerning their relationships.
In this context, modularity refers to a particular organization of genetic effects over phenotypic variation, articulated through development [genotype/phenotype map; @wagner_homologues_1996].
A modular organization of the genotype/phenotype map is thought to emerge as the result of selection for distinct functional demands [@wagner_perspective:_1996; @espinosa-soto_specialization_2010; @rueffler_evolution_2012; @melo_directional_2015]; for instance, the decoupling between fore- and hindlimb function in certain mammalian lineages such as bats [@young_serial_2005] and apes [@young_development_2010] is accompanied with the modularization of both structures, as shown by a reduction of phenotypic correlations among limbs and an increase in correlations within limbs.

The recognition of such variational modules [@wagner_perspective:_1996; @wagner_road_2007] over covariance or correlation patterns in adult populations involves a comprehension of the underlying developmental and functional dynamics among morphological traits [@polly_developmental_2008; @zelditch_epigenetic_2011].
...
The regulation of each step is mediated by different profiles of genetic expression exhibited by cells originated from different embryonic precursors and their response to signaling factors expressed at the regional level [@turing_chemical_1952; @meinhardt_models_2008; @hallgrimsson_deciphering_2009; @franz-odendaal_epigenetics_2011].
...
Considerations based on theoretical [e.g. @lande_genetic_1980; @pavlicev_evolution_2010], experimental [e.g. @hallgrimsson_deciphering_2009; @pavlicev_genetic_2008; @pavlicev_evolution_2011] or simulation-based approaches [e.g. @jones_mutation_2007; @jones_effects_2012; @watson_evolution_2013; @melo_directional_2015] indicate that integration patterns evolve to a equilibrium state dictated by the effect of pleiotropic mutations, stabilizing selection, and genetic drift; thus, changes in integration patterns will be a consequence of changes in one of these components, and such changes are driven by the reorganization of pleiotropic and epistatic interactions among genes.
In this context, stabilizing selection patterns [either over aspects of the developmental system or over the resulting phenotype itself; @hansen_epigenetics:_2011], which is an important feature of selective surfaces [@arnold_adaptive_2001; @arnold_understanding_2008], may be the central component governing the stability and divergence in integration patterns [@hallgrimsson_deciphering_2009; @porto_evolution_2009; @grabowski_divergent_2011; @haber_evolution_2015].

In the past twenty years, there has been a consistent effort in measuring covariance and correlation patterns in different organisms [comparative quantitative genetics; @steppan_comparative_2002], and empirical evidence on the evolution of morphological integration has been accumulating.
Such evidence supports either the stability [e.g. @marroig_comparison_2001; @oliveira_covariance_2009; @porto_evolution_2009; @willmore_comparison_2009] and divergence [e.g. @monteiro_adaptive_2010; @grabowski_divergent_2011; @sanger_roles_2012; @haber_evolution_2015] of integration patterns throughout different levels of  evolutionary divergence. Therefore, whether any of these scenarios is either the rule or exception in morphological evolution remains an open question, although some theoretical and methodological differences among these works need to be considered. 
