...
framework, obtaining static (within populations; Cheverud, 1982; Pélabon
\emph{et al.}, 2013) allometric intercepts ($a_s$) and slopes ($b_s$)
for all spcies simultaneously while considering their phylogenetic
relatedness (see 'Supplemental Information for details).
