...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={},
            pdftitle={Supplemental Material - Allometric Constraints and Modularity},
            colorlinks=true,
            citecolor=blue,
            urlcolor=blue,
            linkcolor=magenta,
...
\setlength{\droptitle}{-2em}
  \title{Supplemental Material - Allometric Constraints and Modularity}
...
et al. (2012). \label{fig:phylo_model}}
\end{figure}
...
\caption{AVG Indexes \emph{vs.} static allometric slopes. For each local
trait set, the shaded region around regression lines indicate 95\%
credible intervals around estimated regression parameters.
\label{fig:MI_vs_slopeW_si}}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics{Figures/lambda_MI-1.pdf}
\caption{Distribution of Pagel's lambda for the mixed regressions
between AVG Indexes for each trait set and static allometric slopes
($b_s$). \label{fig:lambda_MI}}
\end{figure}
