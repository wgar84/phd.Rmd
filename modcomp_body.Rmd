...
With respect to RV values, the differences among the pattern of detection in all representations for local trait sets (\autoref{fig:Func}b) difficult a similar interpretation of the results obtained, as done with the results regarding MHI values.
...
Considering the issues regarding the use of Procrustes estimators for covariance or correlation matrices and the use of RV to measure modular relationships among traits, the approaches we explored here are simple from an operational standpoint.
