...
Covariance matrices derived from morphological traits are supposed to represent the pattern of codependence that arises due to a variety of interactions among developing morphological elements [@olson_morphological_1958; @cheverud_developmental_1996].
Such interactions are the expression of local developmental factors, as they interact with the expression profiles of surrounding cell types, producing coordinated changes in their cycles and differentiation, thus integrating resulting tissues in the adult population.
