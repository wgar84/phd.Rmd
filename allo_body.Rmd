...
captions $ fig.phylo_W <- paste0("**Deviations from ancestral allometry.** (a) Intercepts; (b) Slopes. Red circles indicate positive deviations, while blue circles indicate negative ones. The outer circles indicate whether a given deviation is distinct from zero, using 95\\% credible intervals. Particular clades are indicated as abbreviations (", taxa.legend(), "). \\label{fig:phylo_W}")
...
```{r phylo_new, echo = FALSE, fig.height = 8.6, fig.width = 15, fig.cap = captions $ fig.phylo_W, message = FALSE}
