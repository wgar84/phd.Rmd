...
However, such structure of pleiotropic interactions is dependant upon non-linear effects embedded into the genotype/phenotype map, traditionally viewed in quantitative genetics as dominance and epistasis [@wolf_developmental_2001; @rice_developmental_2004]. Additive covariances then evolve in response to changes in allele frequency in *loci* whose effects modulate these interactions.
