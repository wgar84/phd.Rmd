...
captions $ fig.srd_shape <- 'Mean SRD scores for the first and last two phylogenetic PCs (Global 1-2 and Local 1-2, respectively) represented over the mean skull shape of rhesus macaques (*Macaca mulatta*). \\label{fig:srd_shape}'
