...
## Abstract
Phenotypic traits evolve in a coordinated manner due to developmental and functional interactions, mediated by the dynamics of natural selection; the dependence between traits arising from these three factors is captured by genetic ($\mathbf{G}$) and phenotypic ($\mathbf{P}$) covariance matrices.
