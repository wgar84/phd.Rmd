...
Currently, there is an abundance of methods dedicated to the comparison of covariance structure among lineages [e.g. @krzanowsky_between-groups_1979; @phillips_hierarchical_1999; @cheverud_comparing_2007], and such methods are often focused on constructing null hypothesis of similarity or dissimilarity [@haber_evolution_2015].
Moreover, although these methods provide a measure of (dis)similarity among covariance matrices, they lack a 
...
The interplay between developmental and functional interactions, and their relationships with the structure of adaptive landscapes may both influence the divergence between covariance structure in sister lineages. Thus, in the present work, we evaluate the stability of cranial phenotypic covariance structure along the diversification of Anthropoid Primates, considering that either developmental and functional interactions will produce different degrees of stability among different cranial regions, thus producing a non-random pattern of changes in covariance structure.

Here, we follow the methodology introduced by @haber_evolution_2015 for comparing phenotypic covariance structure under a explicit phylogenetic framework, but with important considerations regarding the topological properties of the set of covariance matrices
