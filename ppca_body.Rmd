...
captions $ fig.loess <- 'Distribution of mean SRD scores for each trait along the entire ordered set of phylogenetic PCs. Skull regions are indicated by the color legend. \\label{fig:loess}'
...
The interplay between developmental and functional interactions, and their relationships with the topology of adaptive landscapes may influence the divergence between covariance structure in sister lineages. In the present work, we evaluate the stability of phenotypic covariance structure in skull size and shape along the diversification of Anthropoid PrimatesX.
