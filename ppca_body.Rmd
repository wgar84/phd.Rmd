...
1. Comparative Quantitative Genetics 101
...
Thus, the additive covariances in $\mathbf{G}$ represent the codependency among traits due to pleiotropy and linkage disequilibrium, representing a linear genotype/phenotype map centered on the mean phenotype [@cheverud_developmental_1996; @wagner_homologues_1996; @wagner_eigenvalue_1984].

However, this structure of pleiotropic interactions depends on non-linear effects embedded into the genotype/phenotype map, traditionally represented in quantitative genetics as either dominance or epistasis [@wolf_developmental_2001; @rice_developmental_2004]. In particular, experimental evidence has accumulated indicating that epistatic *loci* may modulated pleiotropic interactions [refs], which effectively harbor genetic variation in gene-trait mapping among individuals in a population. Genetic covariances among phenotypic traits then evolve as a consequence of shifts in allele frequencies in these *loci*.

  a. Epistasis and the evolution of pleiotropy
