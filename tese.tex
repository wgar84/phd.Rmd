...
significance level. In this case, in an adequate test, we expect that
both quantities, significance level and type I error rate, will be
identical.
...
\url{http://github.com/wgar84/ModComp}. It is noteworthy that previous
tests we made indicated no differences between our estimation of
...
landmarks configurations, we use code provided by Annat Haber, available
at \url{http://life.bio.sunysb.edu/morph/soft-R.html}.
