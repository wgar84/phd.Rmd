...
The comparative analysis of phenotypic covariance structure through
macroevolutionary divergence shows that $\mathbf{P}$ can remain stable
in these large timescales (e.g. Marroig \& Cheverud, 2001; Kolbe
\emph{et al.}, 2011). However, in situations such as dietary (e.g.
Monteiro \& Nogueira, 2010; Haber, 2015) or locomotory (e.g. Young \&
Hallgrímsson, 2005; Young \emph{et al.}, 2010) divergence between sister
lineages, phenotypic covariance structure can be rearranged, and such
reorganization hints at changes in the underlying architecture of the
genotype/phenotype map, indicating that the patterns embedded in the
adaptive landscape can overcome constraints imposed by development
(Jamniczky \& Hallgrímsson, 2009). The relationship between adaptive
landscapes and phenotypic covariance structure is mediated through
performance (Arnold, 1983), which may be thought as a dynamical property
of phenotypes; thus, the separation between developmental and functional
interactions as two distinct factors shaping phenotypic covariance
structure is blurry at least (Cheverud, 1996a; Zelditch \& Swiderski,
2011).

For example, in the mammalian skull, different precursor tissues
originate two distinct regions, Face and Neurocranium, which exhibit
marked contrasts in terms of their interactions with soft tissues, the
functions which they perform, and their response to developmental
milestones, such as birth or weaning (Hallgrímsson \& Lieberman, 2008;
Lieberman, 2011). This contrast is the result of distinct gene
...
2008; Franz-Odendaal, 2011). These signaling factors may be targeted at
specific cell lineages, but the contact between adjoining tissues may
produce correlated changes between them due to mechanical interactions
or through mutual signaling cascades that induce specific behaviors in
neighbor tissues (Cheverud \emph{et al.}, 1992; Ravosa \emph{et al.},
2000; Jiang \emph{et al.}, 2002; Lieberman \emph{et al.}, 2008;
