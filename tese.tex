...
metabolic networks (e.g. Ravasz \emph{et al.}, 2002; Andrade \emph{et
al.}, 2011) to the structure of interactions among individuals in
populations (e.g. Fortuna \emph{et al.}, 2008) and among species in
ecological communities (e.g. Genini \emph{et al.}, 2010).
...
Wagner, 1996), as observed in the covariance or correlation patterns
exhibited by the traits considered. A modular organization of the
genotype/phenotype map is thought to emerge as the result of selection
for distinct functional demands, coupled with the relaxation of
stabilizing selection patterns (Wagner \& Altenberg, 1996; Espinosa-Soto
\& Wagner, 2010; Rueffler \emph{et al.}, 2012; Melo \& Marroig, 2015);
for instance, the decoupling between fore- and hindlimb function in
certain mammalian lineages such as bats (Young \& Hallgrímsson, 2005)
and apes (Young \emph{et al.}, 2010) is accompanied with the
...
of mammalian morphological systems. This source of variation affects the
overall level of phenotypic correlations among morphological traits
...
phenotypes among species (Marroig \& Cheverud, 2005, 2010; Cardini \&
...
stabilizing selection, and genetic drift, and changes in integration
patterns will be a consequence of changes in one of these components;
such changes are driven by the reorganization of pleiotropic and
epistatic interactions among genes. In this context, stabilizing
selection patterns (either over features of the developmental system or
the resulting phenotype itself; Hansen, 2011), which is an important
feature of the adaptive landscape (Arnold \emph{et al.}, 2001, 2008),
may be the central component governing either the stability or
...
measuring covariance and correlation patterns in different organisms, a
research program named `comparative quantitative genetics' by Steppan et
al. (2002), and empirical evidence on the evolution of morphological
integration has accumulated. Such evidence favors either the stability
(e.g. Marroig \& Cheverud, 2001; Oliveira \emph{et al.}, 2009; Porto
\emph{et al.}, 2009; Willmore \emph{et al.}, 2009) or the divergence
(e.g. Monteiro \& Nogueira, 2010; Grabowski \emph{et al.}, 2011; Sanger
\emph{et al.}, 2012; Haber, 2015) of integration patterns throughout
