...
related to masticatory performance, and this effect dominates post-natal
skull growth (Zelditch \emph{et al.}, 1992; Herring, 2011) Thus,
development is composed of a series of such steps, and the influence
these individual processes have on adult phenotypic covariance structure
may be erased by more recent events (Hallgrímsson \emph{et al.}, 2009);
hence, both the temporal hierarchy and the spatial organization of
developmental interactions also influences the patterns expressed in
both $\mathbf{G}$ and $\mathbf{P}$.
