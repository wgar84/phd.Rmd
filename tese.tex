...
with phylogenetic signal (`Global') and convergence (`Local') in matrix
structure (pPC1 and pPC2 in \autoref{fig:matrix_variation}b,
respectively).
...
according to the legend. Some particular clades are indicated
(Platyrrhini: \textbf{Pit}hecidae, \textbf{Ate}lidae, \textbf{Ceb}inae,
\textbf{Cal}lithrichinae, and \textbf{Aot}inae; Catarrhini:
\textbf{Hom}inidae, \textbf{Hyl}obatidae, \textbf{Pap}ionini,
\textbf{Cer}copithecini, and \textbf{Col}obinae).
...
Principal Components. (a) Distribution of eigenvalues associated with
pPCs; positive eigenvalues are associated with phylogenetic signal;
...
\caption{Phylogenetic structures associated with the first and last
pairs of pPCs (Global 1-2 and Local 1-2, respectively), represented as
the projections of each OTU over each axis. White circles indicate
positive values; black circles indicate negative values. The absolute
value of each projection is indicated by the size of the circle,
according to the legend. Some particular clades are indicated
(Platyrrhini: \textbf{Pit}hecidae, \textbf{Ate}lidae, \textbf{Ceb}inae,
\textbf{Cal}lithrichinae, and \textbf{Aot}inae; Catarrhini:
\textbf{Hom}inidae, \textbf{Hyl}obatidae, \textbf{Pap}ionini,
...
last pairs of pPCs (Global 1-2 and Local 1-2, respectively), represented
using posterior mean SRD scores. Traits are colored according to their
