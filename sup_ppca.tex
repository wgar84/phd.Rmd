...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={},
            pdftitle={A Phylogenetic Analysis of Shape Covariance Structure in Anthropoid Primates - Supplemental Material},
            colorlinks=true,
            citecolor=blue,
            urlcolor=blue,
            linkcolor=magenta,
...
Primates - Supplemental Material}
...
\begin{figure}[htbp]
\centering
\includegraphics{Figures/rs_riemd-1.pdf}
...
samples obtained for each OTU. \label{fig:rs_riemd}}
\end{figure}
